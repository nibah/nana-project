...
for year in ['2014', '2015', '2016']:
	for month in ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']:
		monthly_links[year + '-' + month] = ReduceTimeInterval(hyperlinks, year + '-' + month + '-01', year + '-' + month + '-31')
for month in ['01', '02', '03', '04']:	# months in 2017 that we have data for
	monthly_links[year + '-' + month] = ReduceTimeInterval(hyperlinks, '2017-' + month + '-01', '2017-' + month + '-31')
